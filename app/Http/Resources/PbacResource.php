...
class PbacResource extends JsonResource
{
    public function toArray($request)
    {
        return [
            ...
            'blCupLowCount' => $this->bl_cup_low_count,
            'blCupHalfEmptyCount' => $this->bl_cup_half_empty_count,
            'blCupFullCount' => $this->bl_cup_full_count,
            'blPeriodUnderwearCount' => $this->bl_period_underwear_count,
