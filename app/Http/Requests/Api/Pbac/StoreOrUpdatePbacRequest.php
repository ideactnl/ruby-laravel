...
class StoreOrUpdatePbacRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'blCupLowCount' => 'nullable|numeric|min:0|max:9',
            'blCupHalfEmptyCount' => 'nullable|numeric|min:0|max:9',
            'blCupFullCount' => 'nullable|numeric|min:0|max:9',
            'blPeriodUnderwearCount' => 'nullable|numeric|min:0|max:9',
            ...
            'isPeePain' => 'nullable|boolean',
            'isPoopPain' => 'nullable|boolean',
    ...
    public function bodyParameters(): array
    {
        return [
            ...
            'blCupLowCount' => ['description' => 'Count of menstrual cups used (Low)', 'example' => 1, 'required' => false, 'type' => 'numeric'],
            'blCupHalfEmptyCount' => ['description' => 'Count of menstrual cups used (Half Empty)', 'example' => 0, 'required' => false, 'type' => 'numeric'],
            'blCupFullCount' => ['description' => 'Count of menstrual cups used (Full)', 'example' => 0, 'required' => false, 'type' => 'numeric'],
            'blPeriodUnderwearCount' => ['description' => 'Count of period underwear used', 'example' => 1, 'required' => false, 'type' => 'numeric'],
            ...
            'isPeePain' => ['description' => 'Pain during peeing (Urine Domain)', 'example' => 0, 'required' => false, 'type' => 'boolean'],
            'isPoopPain' => ['description' => 'Pain during pooping (Urine Domain)', 'example' => 0, 'required' => false, 'type' => 'boolean'],
            ...
            'isSexPain' => ['description' => 'Had pain during sex', 'example' => 0, 'required' => false, 'type' => 'boolean'],
