...
class Pbac extends Model
{
    ...
    private const BLOOD_LOSS_FIELDS = [
        'is_blood_loss_answered',
        'menstrual_blood_loss',
        'spotting',
        'no_blood_loss',
        'is_bl_first_day_period',
        'is_bl_pads',
        'is_bl_tampon',
        'bl_cup_low_count',
        ...
        'is_bl_very_heavy',
        'is_bl_blood_clots',
        'is_bl_double_protection',
        'is_bl_leaked_clothes',
        'is_bl_change_products',
        'is_bl_wake_up_night',
    ];
    ...
    private const PAIN_FIELDS = [
        ...
        'is_pain_answered',
        'pain_slider_value',
        'is_pain_headache_migraine',
        'is_pain_during_peeing',
        'is_pain_during_pooping',
        'is_pain_during_sex',
        'is_pain_image1_umbilical',
        'is_pain_image1_left_umbilical',
        'is_pain_image1_right_umbilical',
        'is_pain_image1_bladder',
        'is_pain_image1_left_groin',
        'is_pain_image1_right_groin',
        'is_pain_image1_left_leg',
        'is_pain_image1_right_leg',
        'is_pain_image2_upper_back',
        'is_pain_image2_back',
        'is_pain_image2_left_buttock',
        'is_pain_image2_right_buttock',
        'is_pain_image2_left_back_leg',
        'is_pain_image2_right_back_leg',
    ];

    private const IMPACT_FIELDS = [
        'is_impact_answered',
        'impact_slider_grade_your_day',
        'impact_slider_complaints',
        'is_impact_used_medication',
        'is_impact_missed_work',
        'is_impact_missed_school',
        'is_impact_could_not_sport',
        'is_impact_missed_special_activities',
        'is_impact_missed_leisure_activities',
        'is_impact_had_to_sit_more',
        'is_impact_could_not_move',
        'is_impact_had_to_stay_longer_in_bed',
        'is_impact_could_not_do_unpaid_work',
        'is_impact_other',
        'is_impact_other_text',
        'is_impact_med_paracetamol',
        'is_impact_med_diclofenac',
        'is_impact_med_naproxen',
        'is_impact_med_iron_pills',
        'is_impact_med_tramodol',
        'is_impact_med_oxynorm',
        'is_impact_med_anticonception_pill',
        'is_impact_med_other_hormones',
        'is_impact_med_tranexamine_zuur',
        'is_impact_med_other',
        'is_impact_med_other_text',
        'is_impact_medicine_effective',
    ];

    private const GENERAL_HEALTH_FIELDS = [
        'is_general_health_answered',
        'general_health_energy_level_slider_value',
        'is_general_health_dizzy',
        'is_general_health_nauseous',
        'is_general_health_headache_migraine',
        'is_general_health_bloated',
        'is_general_health_painful_sensitive_breasts',
        'is_general_health_acne',
        'is_general_health_muscle_joint_pain',
    ];
    ...
    private const MOOD_FIELDS = [
        ...
        'is_mood_happy',
        'is_mood_excited',
        'is_mood_anxious_stressed',
        'is_mood_ashamed',
        'is_mood_angry_irritable',
        'is_mood_sad',
        'is_mood_swings',
        'is_mood_worthless_guilty',
        'is_mood_overwhelmed',
        'is_mood_hopeless',
        'is_mood_hopes',
        'is_mood_depressed_sad_down',
    ];

    private const URINE_STOOL_FIELDS = [
        'is_urine_stool_answered',
        'is_urine_stool_blood_in_urine',
        'is_urine_stool_blood_in_stool',
        'is_urine_stool_hard',
        'is_urine_stool_normal',
        'is_urine_stool_soft',
        'is_urine_stool_diarrhea',
        'is_urine_stool_something_else',
        'is_urine_stool_something_else_text',
        'is_urine_stool_no_stool',
        'is_pee_pain',
        'is_poop_pain',
    ];
    ...
    private const SLEEP_FIELDS = [
        ...
        'sleep_woke_up_time',
        'sleep_hours_of_sleep',
        'is_sleep_work_school_day',
        'is_sleep_free_day',
        'is_sleep_trouble_asleep',
        'is_sleep_tired_rested',
        'is_sleep_wake_up_during_night',
    ];

    private const EXERCISE_FIELDS = [
        'is_exercise_answered',
        'is_exercise_less_thirty',
        'is_exercise_thirty_to_sixty',
        'is_exercise_greater_sixty',
        'is_exercise_high_impact',
        'is_exercise_low_impact',
        'is_exercise_precision',
    ];
    ...
    private const DIET_FIELDS = [
        ...
        'is_diet_vegetables',
        'is_diet_fruit',
        'is_diet_potato_rice_bread',
        'is_diet_dairy',
        'is_diet_nuts_tofu_tempe',
        'is_diet_eggs',
        'is_diet_fish',
        'is_diet_meat',
        'is_diet_snacks',
    ...
    private const SEX_FIELDS = [
        ...
        'is_sex_today',
        'is_sex_avoided',
        'is_sex_bloodloss_during_after',
        'is_sex_discomfort_pelvic_area',
        'is_sex_emotionally_physically_satisfied',
        'is_sex_skipped_due_to_period',
        'is_sex_pain',
    ];

    private const ADDITIONAL_NOTES_FIELDS = [
        'is_additional_notes_answered',
        'additional_notes',
    ];
    ...
    private const BOOLEAN_CASTS = [
        // Blood Loss
        'is_blood_loss_answered' => 'boolean',
        'spotting' => 'boolean',
        'no_blood_loss' => 'boolean',
        'is_bl_first_day_period' => 'boolean',
        'is_bl_pads' => 'boolean',
        'is_bl_tampon' => 'boolean',
        'is_bl_menstrual_cup' => 'boolean',
        'is_bl_period_underwear' => 'boolean',
        'is_bl_other' => 'boolean',
        'is_bl_very_light' => 'boolean',
        'is_bl_light' => 'boolean',
        'is_bl_moderate' => 'boolean',
        'is_bl_heavy' => 'boolean',
        'is_bl_very_heavy' => 'boolean',
        'is_bl_blood_clots' => 'boolean',
        'is_bl_double_protection' => 'boolean',
        'is_bl_leaked_clothes' => 'boolean',
        'is_bl_change_products' => 'boolean',
        'is_bl_wake_up_night' => 'boolean',

        // Pain
        'no_pain' => 'boolean',
        'is_pain_answered' => 'boolean',
        'is_pain_headache_migraine' => 'boolean',
        'is_pain_during_peeing' => 'boolean',
        'is_pain_during_pooping' => 'boolean',
        'is_pain_during_sex' => 'boolean',
        'is_pain_image1_umbilical' => 'boolean',
        'is_pain_image1_left_umbilical' => 'boolean',
        'is_pain_image1_right_umbilical' => 'boolean',
        'is_pain_image1_bladder' => 'boolean',
        'is_pain_image1_left_groin' => 'boolean',
        'is_pain_image1_right_groin' => 'boolean',
        'is_pain_image1_left_leg' => 'boolean',
        'is_pain_image1_right_leg' => 'boolean',
        'is_pain_image2_upper_back' => 'boolean',
        'is_pain_image2_back' => 'boolean',
        'is_pain_image2_left_buttock' => 'boolean',
        'is_pain_image2_right_buttock' => 'boolean',
        'is_pain_image2_left_back_leg' => 'boolean',
        'is_pain_image2_right_back_leg' => 'boolean',

        // Impact
        'is_impact_answered' => 'boolean',
        'is_impact_used_medication' => 'boolean',
        'is_impact_missed_work' => 'boolean',
        'is_impact_missed_school' => 'boolean',
        'is_impact_could_not_sport' => 'boolean',
        'is_impact_missed_special_activities' => 'boolean',
        'is_impact_missed_leisure_activities' => 'boolean',
        'is_impact_had_to_sit_more' => 'boolean',
        'is_impact_could_not_move' => 'boolean',
        'is_impact_had_to_stay_longer_in_bed' => 'boolean',
        'is_impact_could_not_do_unpaid_work' => 'boolean',
        'is_impact_other' => 'boolean',
        'is_impact_med_paracetamol' => 'boolean',
        'is_impact_med_diclofenac' => 'boolean',
        'is_impact_med_naproxen' => 'boolean',
        'is_impact_med_iron_pills' => 'boolean',
        'is_impact_med_tramodol' => 'boolean',
        'is_impact_med_oxynorm' => 'boolean',
        'is_impact_med_anticonception_pill' => 'boolean',
        'is_impact_med_other_hormones' => 'boolean',
        'is_impact_med_tranexamine_zuur' => 'boolean',
        'is_impact_med_other' => 'boolean',

        // General Health
        'is_general_health_answered' => 'boolean',
        'is_general_health_dizzy' => 'boolean',
        'is_general_health_nauseous' => 'boolean',
        'is_general_health_headache_migraine' => 'boolean',
        'is_general_health_bloated' => 'boolean',
        'is_general_health_painful_sensitive_breasts' => 'boolean',
        'is_general_health_acne' => 'boolean',
        'is_general_health_muscle_joint_pain' => 'boolean',

        // Mood
        'is_mood_answered' => 'boolean',
        'is_mood_calm' => 'boolean',
        'is_mood_happy' => 'boolean',
        'is_mood_excited' => 'boolean',
        'is_mood_anxious_stressed' => 'boolean',
        'is_mood_ashamed' => 'boolean',
        'is_mood_angry_irritable' => 'boolean',
        'is_mood_sad' => 'boolean',
        'is_mood_swings' => 'boolean',
        'is_mood_worthless_guilty' => 'boolean',
        'is_mood_overwhelmed' => 'boolean',
        'is_mood_hopeless' => 'boolean',
        'is_mood_hopes' => 'boolean',
        'is_mood_depressed_sad_down' => 'boolean',

        // Urine & Stool
        'is_urine_stool_answered' => 'boolean',
        'is_urine_stool_blood_in_urine' => 'boolean',
        'is_urine_stool_blood_in_stool' => 'boolean',
        'is_urine_stool_hard' => 'boolean',
        'is_urine_stool_normal' => 'boolean',
        'is_urine_stool_soft' => 'boolean',
        'is_urine_stool_diarrhea' => 'boolean',
        'is_urine_stool_something_else' => 'boolean',
        'is_urine_stool_no_stool' => 'boolean',
        'is_pee_pain' => 'boolean',
        'is_poop_pain' => 'boolean',

        // Sleep
        'is_sleep_answered' => 'boolean',
        'is_sleep_work_school_day' => 'boolean',
        'is_sleep_free_day' => 'boolean',
        'is_sleep_trouble_asleep' => 'boolean',
        'is_sleep_tired_rested' => 'boolean',
        'is_sleep_wake_up_during_night' => 'boolean',

        // Exercise
        'is_exercise_answered' => 'boolean',
        'is_exercise_less_thirty' => 'boolean',
        'is_exercise_thirty_to_sixty' => 'boolean',
        'is_exercise_greater_sixty' => 'boolean',
        'is_exercise_high_impact' => 'boolean',
        'is_exercise_low_impact' => 'boolean',
        'is_exercise_precision' => 'boolean',

        // Diet
        'is_diet_answered' => 'boolean',
        'is_diet_vegetables' => 'boolean',
        'is_diet_fruit' => 'boolean',
        'is_diet_potato_rice_bread' => 'boolean',
        'is_diet_dairy' => 'boolean',
        'is_diet_nuts_tofu_tempe' => 'boolean',
        'is_diet_eggs' => 'boolean',
        'is_diet_fish' => 'boolean',
        'is_diet_meat' => 'boolean',
        'is_diet_snacks' => 'boolean',
        'is_diet_soda' => 'boolean',
        'is_diet_water' => 'boolean',
        'is_diet_coffee' => 'boolean',
        'is_diet_alcohol' => 'boolean',

        // Sex
        'is_sex_answered' => 'boolean',
        'is_sex_today' => 'boolean',
        'is_sex_avoided' => 'boolean',
        'is_sex_bloodloss_during_after' => 'boolean',
        'is_sex_discomfort_pelvic_area' => 'boolean',
        'is_sex_emotionally_physically_satisfied' => 'boolean',
        'is_sex_skipped_due_to_period' => 'boolean',
        'is_sex_pain' => 'boolean',
    ...
    public function getStoolUrineAttribute(): ?array
    {
        ...
        return [
            ...
            'urine' => [
                ...
                'isPainPee' => (bool) ($this->is_pee_pain ?? false),
            ],
            'stool' => [
                ...
                'isPoopPain' => (bool) ($this->is_poop_pain ?? false),
            ],
        ];
    }
