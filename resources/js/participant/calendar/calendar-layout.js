...
export class CalendarLayout {
    ...
    static createEventContent(arg) {
        ...
        if (iconSrc) {
            ...
            img.src = iconSrc;
            img.className =
                "w-6 h-6 object-contain pbac-calendar-icon pbac-tooltip";
            ...
            div.className =
                "w-6 h-6 bg-gray-200 flex items-center justify-center text-xs text-gray-600 pbac-tooltip";
    ...
    static handleEventMount(arg) {
        ...
        if (container && dayFrame) {
            const eventElement =
                arg.el.closest(".fc-daygrid-event-harness") || arg.el;
            ...
            const emptyContainer = dayFrame.querySelector(
    ...
    static applyDayTopCenter(calendarElement) {
        requestAnimationFrame(() => {
            calendarElement
                .querySelectorAll(".fc-daygrid-day-top:not(.justify-center)")
                .forEach((t) => {
    ...
    static addNewClassForMobile() {
        ...
        const filterHasThree =
            window.selectedCalendarTypes &&
            window.selectedCalendarTypes.size === 3;
