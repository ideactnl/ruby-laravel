...
window.modalTranslations = {
    ...
    'modal_impact_great_day': '{{ __('participant.modal_impact_great_day') }}',
    'modal_impact_good_day': '{{ __('participant.modal_impact_good_day') }}',
    'modal_impact_challenging_day': '{{ __('participant.modal_impact_challenging_day') }}',
    'modal_impact_difficult_day': '{{ __('participant.modal_impact_difficult_day') }}',
