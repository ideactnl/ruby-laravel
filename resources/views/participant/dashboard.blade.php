        ...
        <div class="mb-10 flex items-center justify-between">
            ...
            <div class="md:hidden">
                <div id="mobile-date-container"
                    class="flex items-center gap-2 cursor-pointer hover:opacity-80 transition-opacity p-2 -m-2 rounded-lg hover:bg-gray-50"
            ...
            <div class="relative" @click.outside="open=false" x-cloak>
                ...
                <div x-cloak x-show="open" x-transition
                    ...
                    <div class="flex items-center justify-between px-2 pb-2 border-b border-gray-100">
                        <button class="text-xs font-medium text-gray-700 hover:text-gray-900" @click="selectAll()">Reset</button>
                        <button class="text-xs font-medium text-red-600 hover:text-red-700" @click="clearAll()">Clear</button>
                    </div>
                   ...
                   <template x-for="opt in options" :key="opt.value">
                        ...
                        >
                            <div
                                class="w-5 h-5 flex items-center justify-center rounded border border-gray-300 cursor-pointer transition-all duration-200 bg-primary"
                            >
                                <svg x-show="selected.includes(opt.value)" xmlns="http://www.w3.org/2000/svg"
                            ...
                            <span x-text="opt.label"
                                :class="{ 'text-gray-400': !selected.includes(opt.value) && selected.length >= 3 }">
                            </span>
