...
<div x-data="menstruationWrapped({
    translations: {
        ...
        wrapped_day_singular: @js(__('participant.wrapped_day_singular')),
        wrapped_day_plural: @js(__('participant.wrapped_day_plural'))
    }
})" x-init="init()" class="mb-10 mt-1" x-cloak>
            ...
            <div
                ...
                <div class="flex-shrink-0 w-10 h-10 flex items-center justify-center">
                    <img src="{{ asset('images/calender.png') }}"
                        class="size-6 object-contain opacity-80 contrast-75 brightness-110">
                </div>
                ...
                <div class="flex-shrink-0 relative">
                    <img src="{{ asset('images/question.png') }}" class="w-5 h-5 cursor-help hover:opacity-100"
                    ...
                    <div x-show="activeTooltip === 'cycle' && ( data && data.can_calculate )" x-transition.opacity
                        x-cloak @click.away="activeTooltip = null"
                        class="absolute top-full mt-3 md:top-auto md:bottom-full md:mb-3 right-0 z-[99] w-72 md:w-100 p-3 bg-[#FDF8FE] text-black border-primary border text-xs rounded-lg shadow-xl">
                        <template x-if="data && data.can_calculate">
                    ...
                    <div x-show="activeTooltip === 'cycle' && ( !data || !data.can_calculate )" x-transition.opacity
                        x-cloak @click.away="activeTooltip = null"
                        class="absolute top-full mt-3 md:top-auto md:bottom-full md:mb-3 right-0 md:left-0 z-[99] w-72 md:w-[500px] p-3 bg-[#FDF8FE] text-black border-primary border text-xs rounded-lg shadow-xl">
            ...
            <template x-if="data && data.can_calculate">
                <div
                    ...
                    <div class="flex items-center gap-2">
                        <div class="flex-shrink-0 w-10 h-10 flex items-center justify-center">
                            <img src="{{ asset('images/blood_loss.png') }}" class="w-8 h-8 object-contain">
                        </div>
                        <div class="flex-1 min-w-0">
                        ...
                        <div class="flex-shrink-0 relative">
                            ...
                            <div x-show="activeTooltip === 'blood'" x-transition.opacity x-cloak
                                @click.away="activeTooltip = null"
                                class="absolute top-full mt-3 md:top-auto md:bottom-full md:mb-3 right-0 md:w-100 w-72  p-3 bg-[#FDF8FE] text-black border-primary border text-xs rounded-lg shadow-xl z-[99]">
                                <template x-if="data && (data.pbac_score ?? 0) <= 150">
                                    <span>{!! __('participant.wrapped_blood_loss_info_days_only') !!}</span>
                                </template>
                                <template x-if="data && (data.pbac_score ?? 0) > 150">
                                    <span>{!! __('participant.wrapped_blood_loss_info') !!}</span>
                                </template>
                            </div>
                        </div>
                    </div>
            ...
            <template x-if="data && data.can_calculate">
                <div
                    ...
                    <div class="flex-shrink-0 relative">
                        ...
                        <div x-show="activeTooltip === 'pain'" x-transition.opacity x-cloak
                            @click.away="activeTooltip = null"
            ...
            <template x-if="data && data.can_calculate">
                <div
                    ...
                    <div class="flex-shrink-0 relative">
                        ...
                        <div x-show="activeTooltip === 'impact'" x-transition.opacity x-cloak
                            @click.away="activeTooltip = null"
                            class="absolute top-full mt-3 md:top-auto md:bottom-full md:mb-3 right-0 w-72 p-3 bg-[#FDF8FE] text-black border-primary border text-xs rounded-lg shadow-xl z-[99]">
