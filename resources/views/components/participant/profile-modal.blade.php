    ...
    <template x-teleport="body">
        <div class="fixed inset-0 z-[100]" x-show="open" x-transition.opacity.duration.300ms x-cloak style="display:none">
            ...
            <div class="absolute inset-0 flex items-center justify-center p-4" @click.self="open=false">
                ...
                <!-- Modal -->
                <div class="w-full max-w-lg bg-white rounded-3xl shadow-2xl flex flex-col"
                     ...
                     style="max-height: 90vh; min-height: 50vh;">

                    <!-- Header -->
                    <div class="relative px-6 py-5 bg-gradient-to-r from-[var(--color-primary)] to-[var(--color-primary-800)] rounded-t-3xl flex-shrink-0">
                    ...
                    <div class="flex-1 overflow-y-auto px-5 py-5" style="scrollbar-width: thin; scrollbar-color: var(--color-primary) transparent; min-height: calc(50vh - 80px);">

                        <!-- Loading -->
                        <div x-show="loading" x-transition.opacity.duration.200ms class="flex flex-col items-center justify-center h-full">
                            <div class="relative">
                            ...
                            <div class="bg-white rounded-2xl p-4 border border-[var(--color-neutral-200)]">
                                ...
                                <div class="flex justify-between items-start">
                                    ...
                                    <div class="flex items-center gap-2">
                                        ...
                                        <span x-show="!profile?.medical_specialist_pin_expired && profile?.medical_specialist_temporary_pin_expires_at"
