        ...
        <div class="flex justify-between h-16">
            ...
            <div class="flex items-center space-x-4">
                @if(session('medical_specialist_id'))
                    <a href="{{ route('medical-specialist.dashboard') }}" class="text-gray-700 hover:text-indigo-600">Dashboard</a>
                ...
                @else
                    <a href="{{ route('medical-specialist.login') }}" class="text-gray-700 hover:text-indigo-600">Login</a>
                @endif
            </div>
        </div>
    </div>
