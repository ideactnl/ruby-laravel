    ...
    <div class="w-full max-w-md p-8 bg-white rounded shadow-md">
        ...
        <form method="POST" action="{{ route('login') }}">
            ...
            <div class="mb-4 flex items-center">
                <input class="mr-2 rounded border-gray-300 text-indigo-600 shadow-sm focus:border-indigo-500 focus:ring focus:ring-indigo-200 focus:ring-opacity-50" type="checkbox" name="remember" id="remember" {{ old('remember') ? 'checked' : '' }}>
